...
<body>
		...
		<header class="header-area clearfix">
			...
			<div class="social-info d-flex justify-content-between">
				<a href="#"><i class="fa fa-pinterest" aria-hidden="true"></i></a> <a
					...
					href="https://www.facebook.com/112160797011201/"><i
				...
				<div class="row">
							...
							<div class="col-12 col-lg-8">
								<div class="cart-summary">
									...
									<ul class="summary-table">
										...
										<li><span>Order Subtotal:</span> <span>Rs <%=order.getoPrice()%>0
										</span></li>
										<li><span>Advance Waiting to Pay:</span> <span>Rs<%=order.getoAdAmount()%>0
										</span></li>
					...
					<div class="col-12 col-lg-4">
						<div class="cart-summary">
							...
							<p>
								Please Save Your <b>Order Tracking Information</b> for future
								Order Status tracking purpose. Keep This information save with
								you till your order get Completed.
							</p>
							<ul class="summary-table">
			...
			<div class="row align-items-center">
				...
				<div class="col-12 col-lg-4">
					<div class="single_widget_area">
						...
						<!-- Copywrite Text -->
						<p class="copywrite">
							PYRAMID 3D SOLUTIONS &copy;
							<script>
								document.write(new Date().getFullYear());
							</script>
							All rights reserved.<br>Powered by <i class="fa fa-circle"
								aria-hidden="true"></i> by <a href="https://devzone.lk"
								target="_blank">DevZone LK</a>
						</p>
								...
								<div class="collapse navbar-collapse" id="footerNavContent">
									<ul class="navbar-nav ml-auto">
										...
										<li class="nav-item active"><a class="nav-link"
											href="${pageContext.request.contextPath}/Products">Shop</a></li>
										<li class="nav-item"><a class="nav-link"
											href="${pageContext.request.contextPath}/Order/TrackLogin">Track
												Your Order</a></li>
										<li class="nav-item"><a class="nav-link"
											href="${pageContext.request.contextPath}/Public/contact.html">Contact
												Us</a></li>
									</ul>
								</div>
							</nav>
	...
	<script
		src="${pageContext.request.contextPath}/Public/js/jquery/jquery-2.2.4.min.js"></script>
	<!-- Popper js -->
	<script
		src="${pageContext.request.contextPath}/Public/js/popper.min.js"></script>
	<!-- Bootstrap js -->
	<script
